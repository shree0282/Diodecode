...
<div class="container-fluid" style="margin-top: -20px">
   <div class="row" >    
   		<div style="margin: auto; text-align: center; background: #4EC5BF;  padding: 100px; display: block;" >
   			<h1 class="heading" style="color: white;  ">E - Commerce</h1>
   		</div>      
   </div>
</div>
...
<section>
	...
	<div class="container">
		<!-- <div class="row">
		<h1 class="inner-heading">E-COMMERCE</h1>
		</div> -->
		<br> <br> <br>

		<div class="col-md-4" id="nav_magento">
			<div class="col-md-12">
		...
		<div class="col-md-4" id="nav_woocommerce">
			<div class="col-md-12">
				<img class="center" src="images/woocommerce.png">
				<h3 class="lato-serif">WOOCOMMERCE</h3>
				<p class="inner-para">
		...
		<div class="col-md-4" id="nav_custom-made">
			<div class="col-md-12">
